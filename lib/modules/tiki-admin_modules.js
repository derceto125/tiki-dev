...
// $Id: tiki-admin_modules.js 58356 2016-04-18 11:00:19Z jonnybradley $
...
var showModuleEditForm = function(item, options) {
	...
	if (item) {
		...
		modPos = options.modPos || options.formVals.assign_position;
		modOrd = options.modOrd || options.formVals.assign_order;
