{* $Id: tiki-edit_article.tpl 58027 2016-03-20 20:07:20Z lindonb $ *}
	...
	{tabset}
		...
		{tab name="{tr}Image{/tr}"}
			...
			<fieldset class="{if $types.$type.show_image neq 'y'}hidden{/if} form-horizontal">
				...
				<div class="form-group">
					<label for="list_image_x" class="control-label col-md-4">{tr}Width{/tr}</label>
					<div class="input-group col-md-2">
				...
				<div class="form-group">
					<label for="list_image_y" class="control-label col-md-4">{tr}Height{/tr}</label>
					<div class="input-group col-md-2">
